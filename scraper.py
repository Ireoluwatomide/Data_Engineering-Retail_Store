...
class whisky_web_scraping():
    ...
    def get_links(self, url = 'https://www.thewhiskyexchange.com/'):
        ...
        Returns:
            relevant_linkks(List) - A list of only the links that showcase a type of whiskey.
        '''

        self.url = url

        # Generate a BeautifulSoup object called soup
        url = url
        r = requests.get(url)
        soup = BeautifulSoup(r.content, 'lxml')
    ...
    def scrape_whisky(self, url = 'https://www.thewhiskyexchange.com', number_of_pages = 5):
        ...
        Args:
            url(String) - The base url to extract the data frame.
            Default - https://www.thewhiskyexchange.com
        ...
        Returns:
            df(DataFrame) - The entire data scrapped throughout this project in a single DataFrame.
        '''
        ...
        for link in links:
            ...
            try:
                ...
                for page in range(0, number_of_pages):
                    ...
                    # Create a new DataFrame for the first page of each whiskey ttype
                    if page == 0:
